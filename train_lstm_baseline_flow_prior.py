...
if __name__ == "__main__":
    ...
    for epoch in range(1, args.epoch + 1):
        ...
        loader = BasicLSTMVAEFolder('data/rna_jt_32-512/train-split', args.batch_size, num_workers=0)
        for batch in loader:
        ...
        loader = BasicLSTMVAEFolder('data/rna_jt_32-512/validation-split', valid_batch_size, num_workers=0)
        ...
        with torch.no_grad():
            for i in bar:
                ...
                nll_iw += model.nll_iw(batch_sequence, batch_label, 100,
                                       ns=50, latent_vec=latent_vec).sum().item()
            ...
            cur_mi = total_mi / nb_iters / valid_batch_size
